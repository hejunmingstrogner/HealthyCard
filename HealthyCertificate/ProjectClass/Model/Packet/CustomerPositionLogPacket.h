...
@property (nonatomic, assign) float m_fPositionLO; // 定位经度
@property (nonatomic, assign) float m_fPositionLA; // 定位纬度
@property (nonatomic, assign) float m_fPositionDirection; // 定位方向
