...
- (void)setLeftMenuCellItem:(LeftMenuCellItem *)leftMenuCellItem
{
    ...
    [_headerimageView sd_setImageWithURL:[NSURL URLWithString:[NSString stringWithFormat:@"%@customer/getPhoto?cCustCode=%@", [HttpNetworkManager baseURL], gCustomer.custCode]] placeholderImage:[UIImage imageNamed:@"headimage"] options:SDWebImageRefreshCached | SDWebImageRetryFailed];
}
@end
