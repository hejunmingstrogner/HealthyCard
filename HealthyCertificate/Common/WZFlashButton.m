...
//        }
        ...
        if (self.clickBlock) {
            _isIgnoreEvent = YES;
            [self performSelector:@selector(takeTheClickedEvent) withObject:nil afterDelay:self.timeInterval];
         //   [self performSelector:@ withObject:`QQ afterDelay:]
            self.clickBlock();
        }
    }
}
